...
file_path_AX = f"/Volumes/Claudio SSD/Ensemble_article_data/analysis/prob_distribution/{location}_all_long/P_dr{delta_r*100:03.0f}_all_s{subset:03d}.nc"
...
for delta_r in [0.1, 2]:
    ...
    for i in range(1, 51):
        ...
        file_path_AX = f"/Volumes/Claudio SSD/Ensemble_article_data/analysis/prob_distribution/{location}_all_long/P_dr{delta_r*100:03.0f}_all_s{i:03d}.nc"
        P_AX = xr.open_dataset(file_path_AX)
...
for week in [4, 20]:
    ...
    for i in range(1, 50):
        ...
        file_path_AX = f"/Volumes/Claudio SSD/Ensemble_article_data/analysis/prob_distribution/{location}_all_long/P_W{week:02d}_all_s{i:03d}.nc"
        P_AX = xr.open_dataset(file_path_AX)
...
ax1.set_ylim(0., 10.5)
ax1.semilogx()
ax1.legend(shadow=True, fontsize=9, loc='upper left')
...
ax2.set_ylim(0., 10.5)
ax2.semilogx()
ax2.legend(shadow=True, fontsize=10, loc='upper left')
