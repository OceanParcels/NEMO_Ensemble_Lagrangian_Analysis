...
member = 1 # memeber
K_h = 10 # Standard deviation od initial dispersion
...
K_h_ranges = [10] # np.linspace(0.1, 1, 10)
...
for member in tqdm(members):
    for K_h in K_h_ranges:
        ...
        save_path = f"/storage/shared/oceanparcels/output_data/data_Claudio/NEMO_Ensemble/analysis/prob_distribution/{location}_diffusion_long/P_diff_Kh_{K_h:01d}_m{member:03d}.nc"
