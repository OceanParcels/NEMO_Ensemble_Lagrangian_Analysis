...
path = f"/storage/shared/oceanparcels/output_data/data_Claudio/NEMO_Ensemble/{location}/temporal_connectivity/dep_{depth:01d}/{location}_dep{depth:01d}_m{member:03d}.zarr"
pset = xr.open_zarr(path)
obs_range = pset.obs.values
...
for member in tqdm(members):
    ...
    print(f"\U0001F914 Member: {member:03d},  Depth: {depth}")
    ...
    save_path = f"/storage/shared/oceanparcels/output_data/data_Claudio/NEMO_Ensemble/analysis/prob_distribution/Connectivity/dep_{depth:01d}/Pconn_dep_{depth:01d}_m{member:03d}.nc"
